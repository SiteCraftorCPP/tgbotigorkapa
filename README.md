...
### Для админов (управление ботом):
- `/enable` - Включить бота
- `/disable` - Выключить бота
- `/config` - Текущие настройки

### Для админов (настройка параметров):
...
### Для админов (управление админами):
...
### ⚠️ ВАЖНО: Настройки управляются через Telegram!

Все настройки хранятся в БД и управляются через Telegram-команды **только администраторами**.

### Добавление администраторов

**См. файл ADMIN_SETUP.md для подробной инструкции**
...
### Изменение настроек через Telegram

После добавления админов, все настройки меняются командами:

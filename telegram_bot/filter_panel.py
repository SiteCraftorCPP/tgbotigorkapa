...
├ Свеча сигнала: тело ≥ 55% и ≤ 1.8× среднего тела за 20 свечей
├ Структурное подтверждение обязательно (HH+HL для лонга / LL+LH для шорта)
├ Pullback перед сигналом в диапазоне 0.1–1.0 ATR
├ EMA50 направлена в сторону сигнала; отклонение ≤ 2.5 ATR
├ Уровень подтверждён минимум 2 касаниями (HTF — объём ≥ 1.2× среднего)
├ Пробой уровня: тело ≥ 50% свечи относительно уровня
